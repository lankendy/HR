...
export class ButtonDeleteComponent implements OnInit {
  ...
  @Input('confirmOkI18n') confirmOkI18n: string = "layout.confirm.delete.confirm.delete";
  @Input('confirmCancelI18n') confirmCancelI18n: string = "layout.confirm.delete.confirm.cancel";
  @Input('confirmTitleI18n') confirmTitleI18n: string = "layout.confirm.delete.confirm";
